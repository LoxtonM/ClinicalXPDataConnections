...
{
    public interface IHPOCodeDataAsync
    {
        public Task<List<HPOTermDetails>> GetHPOTermsAddedList(int id);
        public Task<List<HPOTerm>> GetHPOTermsList();
        public Task<List<HPOTermDetails>> GetExistingHPOTermsList(int id);
        public Task<List<HPOExtractedTerms>> GetExtractedTermsList(int noteID, IConfiguration _config);
        public Task<HPOTerm> GetHPOTermByTermCode(string hpoTermCode);
        public Task<HPOTerm> GetHPOTermByID(int id);
    ...
    public class HPOCodeDataAsync : IHPOCodeDataAsync
    {
        private readonly ClinicalContext _clinContext;

        public HPOCodeDataAsync(ClinicalContext context)
        {
            _clinContext = context;
        }
        
        public async Task<List<HPOTermDetails>> GetHPOTermsAddedList(int id) //Get list of HPO codes added to a patient by MPI
        {
        ...
        public async Task<List<HPOTerm>> GetHPOTermsList() //Get list of all possible HPO codes
        {
        ...
        public async Task<List<HPOTermDetails>> GetExistingHPOTermsList(int id) //Get list of all HPO codes added to a clinical note, by the ClinicalNoteID
        {
        ...
        public async Task<List<HPOExtractedTerms>> GetExtractedTermsList(int noteID, IConfiguration _config) //Get list of HPO codes that can be extracted from a clinical note, by ClinicalNoteID
        {
